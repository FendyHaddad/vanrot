...
| AI rules `.vanrot/ai-rules.md` | cli | Phase 7 | Generates provider-neutral Vanrot rules file | Customization, merge behavior, docs synchronization, and provider-independent workflows verified | Planned | Phase 7 owns deterministic local rules, not AI provider integration. |
