...
| docs and web | `apps/vanrot-site` workspace app | Demo-Capable through Phase 16C | Site builds as a Vanrot app with router, pages, October tokens, `vanrotstyles.css`, a Phase 16B primitive gallery, and Phase 16B primitives. | Phase 16C, Phase 24 | Phase 24 remains the exhaustive final docs audit. |
