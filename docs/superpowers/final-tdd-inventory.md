...
| Area | Item | Current Maturity | Final TDD Expectation | Owner Phase | Notes |
|------|------|------------------|-----------------------|-------------|-------|
| binary | `vr` command entry | Demo-Capable | Installed binary runs on supported platforms, handles help/errors, and exits with correct codes. | Phase 5, Phase 14, Phase 26 | Package exposes `vr`. |
